...
public partial class Subjects : Window
{
    ...
    {
        cmbStudents.ItemsSource = LoginPage.students;
    ...
    private void btnAdd_Click(object sender, RoutedEventArgs e)
    {
        ...
        var selectedStudent = cmbStudents.SelectedItem as LoginPage.Student;
        var selectedSubject = cmbSubjects.SelectedItem as LoginPage.Subject;
    ...
    private void UpdateStudentSubjects(LoginPage.Student student)
    {
    ...
    {
        UpdateStudentSubjects(cmbStudents.SelectedItem as LoginPage.Student);
    }
}